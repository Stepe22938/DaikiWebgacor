...
const items = [
  {
    ...
    rarity: "A",
    value: "7",
    description: "Akses keuntungan tier Premium selama 7 hari penuh.",
    price: 350,
    isGacha: false,
    isShop: true
  },
  {
    ...
    rarity: "S",
    value: "30",
    description: "Akses keuntungan tier Premium selama 30 hari penuh.",
    price: 1200,
    isGacha: false,
    isShop: true
  },
  {
    ...
    rarity: "S",
    value: "90",
    description: "Paket hemat! Akses keuntungan tier Premium selama 90 hari penuh.",
    price: 3000,
    isGacha: false,
    isShop: true
  }
...
async function seed() {
  try {
    console.log("Seeding premium packages into shop...");
